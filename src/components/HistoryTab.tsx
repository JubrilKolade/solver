...
interface HistoryTabProps {
  history: Solution[];
  clearHistory: () => void;
  onHistoryClick: (sol: Solution) => void;
            ...
            >
              <div className="flex items-center justify-between gap-4">
                <div className="flex-1 min-w-0">
                  ...
                  <div className="font-mono text-sm mt-1.5 truncate" style={{ color: 'var(--text-secondary)' }}>
                    {sol.problem}
                  </div>
                </div>
                <div className="text-right shrink-0">
                  <div className="text-xs mb-1" style={{ color: 'var(--text-muted)' }}>Answer</div>
                  <div className="font-display text-sm accent-text-gradient">{sol.result}</div>
                </div>
