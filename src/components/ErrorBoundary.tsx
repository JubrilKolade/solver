    ...
    if (this.state.hasError) {
      return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 to-slate-800 p-4">
          <div className="max-w-md w-full bg-white/5 backdrop-blur-xl rounded-2xl border border-red-500/20 p-8 text-center">
            ...
            {process.env.NODE_ENV === 'development' && this.state.error && (
              <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-4 mb-4 text-left max-h-40 overflow-auto">
                ...
                {this.state.errorInfo && (
                  <pre className="text-red-200 font-mono text-xs mt-2 whitespace-pre-wrap break-words">
